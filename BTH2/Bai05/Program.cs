...
namespace Bai05
{
    class BatDongSan
    {
        public BatDongSan(string DD, int GB, float DT)
        {
            Dia_Diem = DD;
            Gia_Ban = GB;
            Dien_Tich = DT;
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Tong gia nha pho la: {0}", TGNP);
            Console.WriteLine("Tong gia khu dat la: {0}", TGKD);
            Console.WriteLine("Tong gia chung cu la: {0}", TGCC);
